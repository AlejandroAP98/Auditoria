...
class LifeInsuranceUpdatedAdmin extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ->subject('Actualización Seguro de Vida')
            ->line('Se ha actualizado la información del seguro de vida del siguiente usuario.')
